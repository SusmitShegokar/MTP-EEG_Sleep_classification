...
def train_model(args, model,
          ...
          history = {"Train": {"Score": [], "Loss": []},
                     "Valid": {"Score": [], "Loss": []}},
          mixup_data=None, supervised_mixup_data=None, mixup_idx=None, mixup_rate=None,filename = None):
	...
	print("train loss"+history["Train"]["Loss"].top)
	print("train score"+history["Train"]["Score"].top)
	print( "val loss"+history["Valid"]["Loss"].top)
	print("val score"+ history["Valid"]["Score"].top)
	with open(meta_file_path, "a") as f:
        f.write("\n train loss"+history["Train"]["Loss"].top)
		f.write("\n train score"+history["Train"]["Score"].top)
		f.write( "\n val loss"+history["Valid"]["Loss"].top)
		f.write("\n val score"+ history["Valid"]["Score"].top)
