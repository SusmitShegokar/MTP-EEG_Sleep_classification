...
DATA_FOLDER ='/home/deepak/Documents/Deepak/Students/Susmit_23CS60R75/model_final/with_sub/sleep_data_subject/Sleep_Data/'
SOURCE_DATA_FOLDER = DATA_FOLDER  + "SleepSource/train/"
LEADERBOARD_TARGET_DATA_FOLDER = DATA_FOLDER + "SleepSource/val/"
# LEADERBOARD_TEST_DATA_FOLDER = DATA_FOLDER + "LeaderboardSleep/testing/"
FINAL_TARGET_DATA_FOLDER = DATA_FOLDER + "SleepSource/test/"
...
def get_phase_1_data():
    ...
    val_target_data, val_target_subjects = load_data(LEADERBOARD_TARGET_DATA_FOLDER)
    val_target_data, val_target_labels = prepare_window_data(val_target_data, val_target_subjects)
    val_target_data = normalize(val_target_data, source_mean, source_std, "Leadeboard target")
    ...
    # lb_test_data = normalize(lb_test_data, source_mean, source_std, "Leadeboard test")
        ...
        # load and normalize target data
    test_target_data, test_target_subjects = load_data(FINAL_TARGET_DATA_FOLDER)
    test_target_data, test_target_labels = prepare_window_data(test_target_data, test_target_subjects)
    test_target_data = normalize(test_target_data, source_mean, source_std, "Final target")
    # load and normalize test data
    ...
    return source_data, source_labels, val_target_data, val_target_labels,test_target_data, test_target_labels



def split_train_val_test(train_data, train_labels, val_target_data, val_target_labels,test_target_data, test_target_labels):
    ...
    train_labels_split = train_labels
    val_data = val_target_data
    val_labels = val_target_labels
    test_data = test_target_data
    test_labels = test_target_labels
...
source_data, source_labels, val_target_data, val_target_labels,test_target_data, test_target_labels = get_phase_1_data()
...
splits = split_train_val_test(source_data, source_labels, val_target_data, val_target_labels,test_target_data, test_target_labels)
